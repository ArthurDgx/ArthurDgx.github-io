...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [Widget_key]: null,
        [HomePage_title]: "Flutter Example App"
      });
    },
    get C2() {
  ...
  var HomePage_title = dart.privateName(main, "HomePage.title");
  main.App = class App extends framework.StatelessWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.App.new({key: key});
    }
    build(context) {
      return new app.MaterialApp.new({title: "Layout", theme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.indigo, useMaterial3: true, brightness: ui.Brightness.light}), darkTheme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.blue, useMaterial3: true, brightness: ui.Brightness.dark}), home: C[1] || CT.C1, debugShowCheckedModeBanner: false});
    }
  };
  (main.App.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.App.__proto__.new.call(this, {key: key});
    ;
  ...
  main.HomePage = class HomePage extends framework.StatefulWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new main.HomePage.new({key: key, title: title});
    }
    createState() {
  ...
  main._HomePageState = class _HomePageState extends framework.State$(main.HomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new basic.Expanded.new({flex: 1, child: new container.Container.new({alignment: alignment.Alignment.center, child: C[2] || CT.C2})}), new basic.Expanded.new({flex: 8, child: new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.spaceAround, children: T.JSArrayOfWidget().of([new basic.Expanded.new({child: new container.Container.new({alignment: alignment.Alignment.center, child: new text.Text.new("primeira coluna")})}), new basic.Expanded.new({flex: 3, child: new container.Container.new({alignment: alignment.Alignment.center, decoration: new box_decoration.BoxDecoration.new({color: colors.Colors.blue, borderRadius: new border_radius.BorderRadius.circular(20)}), child: new text.Text.new("segunda coluna")})}), new basic.Expanded.new({child: new container.Container.new({alignment: alignment.Alignment.center, child: new text.Text.new("terceira coluna")})})])})}), new basic.Expanded.new({child: new container.Container.new({alignment: alignment.Alignment.center, child: C[3] || CT.C3})})])})}), floatingActionButton: new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _incrementCounter), tooltip: "Increment", child: C[4] || CT.C4})});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC7C4B;AACxB,YAAO,iCACE,iBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QAnBiB;AAAX,4CAAW,GAAG;;EAAE;;;;;;;;;;IAyBT;;;;;;;;;;;;AAGoB;IAAgB;;;QAL3B;QAAmB;;AAAnC,iDAAgB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAc5C,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;UAG0B;AACxB,YAAO,oCACG,+BACC,kBAAK,AAAO,4BAEf,6BACG,yCACgC,yCACnB,wBAChB,8BACQ,UACC,wCAEgB,sDAMzB,8BACQ,UACC,sCACgC,8CAC3B,wBACR,+BACS,wCACgB,mCAEd,kBAAK,wBAGhB,8BACQ,UACC,wCACgB,wCACT,6CACM,kCACa,wCAAS,cACjC,kBAAK,uBAGhB,+BACS,wCACgB,mCAEd,kBAAK,8BAMtB,+BACS,wCAEgB,kFAST,0EACT,mCACF;IAIf;;;;;;IA9EI,iBAAW;;;EA+EjB;;;;;;;;;;;;;;AAnHqB,IAAnB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
